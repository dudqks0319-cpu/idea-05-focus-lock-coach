...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _openEditor({FocusTask? existing}) async {
    final task = await Navigator.of(context).push<FocusTask>(
      MaterialPageRoute(
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: const [
                Text('집중시간 잠금 코치', style: TextStyle(fontWeight: FontWeight.bold)),
                SizedBox(height: 4),
