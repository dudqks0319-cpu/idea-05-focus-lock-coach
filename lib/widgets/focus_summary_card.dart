    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('현재 집중 상태', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Row(
              children: [
                Expanded(child: Text('집중 강도: $currentFocusLevel / 5')),
                SizedBox(
                  width: 180,
                  child: Slider(
                    value: currentFocusLevel.toDouble(),
                    min: 1,
                    max: 5,
                    divisions: 4,
                    label: '$currentFocusLevel',
