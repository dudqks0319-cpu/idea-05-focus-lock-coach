...
class FocusLockCoachApp extends StatefulWidget {
  const FocusLockCoachApp({super.key, required this.service});

  final SupabaseService service;

  @override
  State<FocusLockCoachApp> createState() => _FocusLockCoachAppState();
}

class _FocusLockCoachAppState extends State<FocusLockCoachApp> {
