...
import 'package:app_05_focus_lock_coach/app.dart';
import 'package:app_05_focus_lock_coach/services/supabase_service.dart';

void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    final service = await SupabaseService.bootstrapFromEnvironment();
    await tester.pumpWidget(FocusLockCoachApp(service: service));
    ...
    expect(find.text('집중시간 잠금 코치'), findsWidgets);
